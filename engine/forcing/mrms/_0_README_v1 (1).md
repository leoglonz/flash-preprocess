...
**Externally supplied files needed:**
- `final_events (6).csv` — candidate storm/flood event list
- `gages2_lt1000km2.csv` — USGS gage list (basin area < 1000 km²)
...
| 2 | `final_events (6).csv`, `gages2_lt1000km2.csv`, HUC8 shapefile | `huc8_selection_outputs/*`, CONUS crosswalk |
